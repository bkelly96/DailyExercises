...
import com.revature.day3.day5.beans.EmployeeLastNameComparator;

import java.util.Iterator;
import java.util.TreeSet;

import static com.revature.day3.day5.beans.Employee.parseEmployee;
...
public class TreeSetDemo_03 {
    public static void main(String[] args) {
        ...
        EmployeeLastNameComparator employeeLastNameComparator = new EmployeeLastNameComparator();
        TreeSet<Employee> employees = new TreeSet<>(employeeLastNameComparator);
